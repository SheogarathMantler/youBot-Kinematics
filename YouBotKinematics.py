...
def gripperPositionFromT(T):
    px = T[0][3]
    py = T[1][3]
    pz = T[2][3]
    return np.array([px, py, pz])

# function calculating phi from vectors a and p
def calcPhi(a, p):
    return vg.angle(a, p)
...
print(inversePositionKinematics(10,10,10,1))
print(inversePositionKinematics(100,20,30,5))
